...
router.put('/user/profile/image', authenticateToken, upload.single('image'), async (req, res) => {
  if (!req.file) {
...
router.get('/user/profile/image', authenticateToken, async (req, res) => {
  try {
